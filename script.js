/*
const G3 = new Audio("https://hasanbahadirkoca.com/piano/sounds/G3.mp3");
const Ab3 = new Audio("https://hasanbahadirkoca.com/piano/sounds/Ab3.mp3");
const A3 = new Audio("https://hasanbahadirkoca.com/piano/sounds/A3.mp3");
const Bb3 = new Audio("https://hasanbahadirkoca.com/piano/sounds/Bb3.mp3");
const B3 = new Audio("https://hasanbahadirkoca.com/piano/sounds/B3.mp3");
const C4 = new Audio("https://hasanbahadirkoca.com/piano/sounds/C4.mp3");
const Db4 = new Audio("https://hasanbahadirkoca.com/piano/sounds/Db4.mp3");
const D4 = new Audio("https://hasanbahadirkoca.com/piano/sounds/D4.mp3");
const Eb4 = new Audio("https://hasanbahadirkoca.com/piano/sounds/Eb4.mp3");
const E4 = new Audio("https://hasanbahadirkoca.com/piano/sounds/E4.mp3");
const F4 = new Audio("https://hasanbahadirkoca.com/piano/sounds/F4.mp3");
const Gb4 = new Audio("https://hasanbahadirkoca.com/piano/sounds/Gb4.mp3");
const G4 = new Audio("https://hasanbahadirkoca.com/piano/sounds/G4.mp3");
const Ab4 = new Audio("https://hasanbahadirkoca.com/piano/sounds/Ab4.mp3");
const A4 = new Audio("https://hasanbahadirkoca.com/piano/sounds/A4.mp3");
const Bb4 = new Audio("https://hasanbahadirkoca.com/piano/sounds/Bb4.mp3");
const B4 = new Audio("https://hasanbahadirkoca.com/piano/sounds/B4.mp3");
const C5 = new Audio("https://hasanbahadirkoca.com/piano/sounds/C5.mp3");
const Db5 = new Audio("https://hasanbahadirkoca.com/piano/sounds/Db5.mp3");
const D5 = new Audio("https://hasanbahadirkoca.com/piano/sounds/D5.mp3");
const Eb5 = new Audio("https://hasanbahadirkoca.com/piano/sounds/Eb5.mp3");
const E5 = new Audio("https://hasanbahadirkoca.com/piano/sounds/E5.mp3");
*/
...
const playSound = audio => {
    ...
    clone.play();
    setTimeout(() => (clone.volume = 0.8), 450);
    setTimeout(() => (clone.volume = 0.6), 900);
    setTimeout(() => (clone.volume = 0.4), 1400);
    setTimeout(() => (clone.volume = 0.2), 2000);
    setTimeout(() => (clone.volume = 0), 2800);
};
...
window.addEventListener("keydown", ({ keyCode }) => {
    ...
    // Press TAB
    if (keyCode === 9) return playG3();

    // Press 1
    if (keyCode === 49) return playAb3();

    // Press Q
    if (keyCode === 81) return playA3();

    // Press 2
    if (keyCode === 50) return playBb3();

    // Press W
    if (keyCode === 87) return playB3();

    // Press E
    if (keyCode === 69) return playC4();

    // Press 4
    if (keyCode === 52) return playDb4();

    // Press R
    if (keyCode === 82) return playD4();

    // Press 5
    if (keyCode === 53) return playEb4();
    ...
    // Press 7
    if (keyCode === 55) return playGb4();

    // Press U
    if (keyCode === 85) return playG4();

    // Press 8
    if (keyCode === 56) return playAb4();

    // Press I
    if (keyCode === 73) return playA4();

    // Press 9
    if (keyCode === 57) return playBb4();

    // Press O
    if (keyCode === 79) return playB4();

    // Press P
    if (keyCode === 80) return playC5();

    // Press *
    //if (keyCode === 189) return playDb5();

    // Press Ğ
    if (keyCode === 219) return playD5();

    // Press -
    //if (keyCode === 189) return playEb5();

    // Press P
    if (keyCode === 221) return playE5();
});
